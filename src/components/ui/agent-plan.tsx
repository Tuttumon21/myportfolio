...
const initialTasks: Task[] = [
    ...
    subtasks: [
      {
        ...
        description: "Basic Setup for Project and Components",
        status: "completed",
        priority: "high",
      ...
      },
      {
        ...
        description: "Responsive all pages",
        status: "in-progress",
        priority: "medium",
  ...
  },
  {
    ...
    description: "Hosting website on Render",
    status: "in-progress",
    priority: "high",
    level: 0,
    dependencies: [],
...
export default function Plan() {
  ...
  return (
    <div className="h-full overflow-auto p-2 text-white">
      <motion.div
        className="border-border rounded-lg border shadow overflow-hidden"
