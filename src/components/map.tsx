                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-sm font-medium px-2 py-0.5 rounded-md bg-black/95 text-white border border-gray-200shadow-sm">
                          {dot.start.label}
                        </span>
                      </div>
                    </foreignObject>
              ...
              <g key={`end-${i}`}>
                ...
                {showLabels && dot.end.label && (
                  ...
                  >
                    ...
                    >
                      <div className="flex items-center justify-center h-full">
                        <span className="text-sm font-medium px-2 py-0.5 rounded-md bg-black/95 text-white border border-gray-200 shadow-sm">
                          {dot.end.label}
                        </span>
                      </div>
                    </foreignObject>
