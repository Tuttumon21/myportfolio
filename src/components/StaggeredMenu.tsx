            ...
            >
              {items && items.length ? (
                items.map((it, idx) => (
                  ...
                  >
                    <button
                      className="sm-panel-item relative text-black font-semibold text-[4rem] cursor-pointer leading-none tracking-[-2px] uppercase transition-[background,color] duration-150 ease-linear inline-block no-underline pr-[1.4em] bg-transparent border-none"
                      onClick={() => {
                        const section = document.getElementById(it.link);
                      ...
                      data-index={idx + 1}
                    >
                      <span className="sm-panel-itemLabel text-5xl font-bold inline-block transform-origin-bottom will-change-transform">
                        {it.label}
                      </span>
                    </button>
                  </li>
